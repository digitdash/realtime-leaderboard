<template>
  <div>
    ...
    <div class="display-name" style="font-weight:bold;">Username</div>
    <div class="score" style="font-weight:bold;">Wagered </div>
    <div class="score" style="font-weight:bold;">Prize </div>
  </div>
    <div
    ...
    >
      ...
      <div class="score">${{ streamer.showScore }}.00</div>
